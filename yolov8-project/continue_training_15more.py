"""
Continue Training Script - 15 MORE EPOCHS
==========================================
...
# Training parameters
ADDITIONAL_EPOCHS = 15  # 15 more epochs
BATCH_SIZE = 8
IMAGE_SIZE = 640

print("=" * 90)
print("🚀 CONTINUING TRAINING - 15 MORE EPOCHS FROM 20-EPOCH MODEL")
print("=" * 90)
...
# ===========================
print("=" * 90)
print("🔥 RESUMING TRAINING - 15 MORE EPOCHS")
print("=" * 90)
print()
...
print()
print("⏱️  Estimated time: ~1.5 hours")
print("=" * 90)
...
results = model.train(
    ...
    # Optimizer settings - fine-tuning with lower LR
    optimizer='AdamW',
    lr0=0.0002,  # Even lower learning rate for fine-tuning
...
try:
    results_csv = Path('runs/detect/continue_training_15more/results.csv')
...
print(f"💾 New best model saved at: runs/detect/continue_training_15more/weights/best.pt")
print(f"📊 All results saved in: runs/detect/continue_training_15more/")
print()
...
best_model_path = 'runs/detect/continue_training_15more/weights/best.pt'
...
print()
print("=" * 90)
print("✅ CONTINUED TRAINING (15 MORE EPOCHS) COMPLETE!")
print("=" * 90)
print()
print(f"💡 Model ready to use: runs/detect/continue_training_15more/weights/best.pt")
print("=" * 90)
